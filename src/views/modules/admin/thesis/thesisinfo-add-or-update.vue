<template>
  <el-dialog
    ...
    <el-form-item label="摘要" prop="description">
      <el-input v-model="dataForm.description" placeholder="摘要"></el-input>
    </el-form-item>
    ...
    <el-form-item label="任务书路径" prop="taskPath">
      <el-input v-model="dataForm.taskPath" placeholder="任务书路径"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          studentNo: [
            { required: true, message: '备选状态不能为空', trigger: 'blur' }
          ],
          taskPath: [
            { required: true, message: '任务书路径不能为空', trigger: 'blur' }
          ],
          gmtCreate: [
